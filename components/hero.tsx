...
export default async function Hero() {
  ...
  const data = await getHeroContent(isEnabled)
            ...
            >
              <div>
                <a
                  ...
                  href={content.ctas.items[0].route}
                >
                  {content.ctas.items[0].label}{" "}
                  <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                    -&gt;
                  </span>
                </a>
              ...
              <div>
                <a
                  ...
                  href={content.ctas.items[1].route}
                >
                  <svg
                  ...
                  <span>{content.ctas.items[1].label} </span>
                </a>
              </div>
            </div>
          </div>
